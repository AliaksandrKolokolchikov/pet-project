...
type menuList = DashboardTypes;

export const DashboardWrapper = () => {
  const [selected, setSelected] = useState<menuList>(DashboardTypes.DASHBOARD);
          ...
          <div className="flex flex-col">
            ...
            >
              {selected === DashboardTypes.DASHBOARD ? (
                ...
                <img className="ml-5" src={grayDash} alt="grayDash" />
              )}
              <p>Dashboard</p>
            </div>
            ...
            >
              {selected === DashboardTypes.WISHLIST ? (
                <img className="ml-5" src={blackWish} alt="blackwish" />
              ) : (
                <img className="ml-5" src={wish} alt="wish" />
              )}
              <p>Wishlist</p>
            </div>
            ...
            >
              {selected === DashboardTypes.CART ? (
                <img className="ml-5" src={blackCart} alt="blackCart" />
              ) : (
                <img className="ml-5" src={cart} alt="cart" />
              )}
              <p>Shopping Cart</p>
            </div>
            <div
            ...
            >
              {selected === DashboardTypes.SETTINGS ? (
                <img className="ml-5" src={activeSetting} alt="activeSetting" />
              ) : (
                <img className="ml-5" src={setting} alt="setting" />
              )}
              <p>Settings</p>
            </div>
            <div
              onClick={() => setSelected(DashboardTypes.LOGOUT)}
              className={`flex items-center gap-2 pb-3 h-[56px] ${
            ...
            >
              {selected === DashboardTypes.LOGOUT ? (
                <img className="ml-5" src={blackOut} alt="blackOut" />
              ) : (
