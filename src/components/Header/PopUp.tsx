...
export const PopUp = forwardRef<HTMLDivElement, Props>(({ setIsShow }, ref) => {
  ...
  return (
    <>
      <div
        ref={ref}
        className="justify-end items-center  flex overflow-x-hidden touch-none fixed inset-0 z-50 outline-none focus:outline-none font-Poppins top-0"
      >
